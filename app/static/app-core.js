...
const state = {
  ...
  voiceAnswerText: '', voiceGeneration: 0,
  ...
  memoryBatch: null, batchWatching: false, batchPollTimer: null, memoriesView: 'grid', activeQuizPrompt: null, recordSession: 0, uploadInFlight: false,
